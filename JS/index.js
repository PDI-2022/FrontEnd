...
function returnHome(anchor = "") {
  window.location.assign(
    anchor === "" ? "/index.html" : `/index.html#${anchor}`
  );
}
...
function showTextAndIcon(input, name) {
  ...
  if (input == "externa") {
    document
      .getElementsByClassName("imgExtIconContainer")[0]
      .appendChild(elem1);
    document
      .getElementsByClassName("imgExtIconContainer")[0]
      .appendChild(elem2);
    ...
    document
      .getElementsByClassName("imgIntIconContainer")[0]
      .appendChild(elem1);
    document
      .getElementsByClassName("imgIntIconContainer")[0]
      .appendChild(elem2);
...
document
  .getElementById("imgButtonInt")
  .addEventListener("change", readImage2, false);
